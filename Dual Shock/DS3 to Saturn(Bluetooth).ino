 ...
 if(power_on){
	if (PS3.PS3Connected) {
		...
		if(mode_Selector==0){
			...
			emulateDigitalController();//with stick enabled
			SetLed(); //set led three on
		}
	}
	else{
...
////////Handshake////////
	...
	if(readS0()==0){
		...
		if(PS3.getButtonPress(CIRCLE)){DATA1_2 &= B00001110;}
		//If the C button pressed
		if(PS3.getButtonPress(R3)){DATA1_2 &= B00001101;}
		//If the A button pressed
		if(PS3.getButtonPress(CROSS)){DATA1_2 &= B00001011;}
		//If the Start button pressed
		if (PS3.getButtonPress(PS)){DATA1_2 &= B00000111;}
		
		//If the Z button pressed
		if(PS3.getButtonPress(L3)){DATA2_1 &= B00001110;}
		//If the Y button pressed
		if(PS3.getButtonPress(TRIANGLE)){DATA2_1 &= B00001101;}
		//If the X button pressed
		if(PS3.getButtonPress(SQUARE)){DATA2_1 &= B00001011;}
		//If the Right trigger button pressed
		if(PS3.getButtonPress(R1)){DATA2_1 &= B00000111;}
		
		//If the Left trigger button pressed
		if(PS3.getButtonPress(L1)){DATA2_2 &= B00000111;}
